...
export default function Footer() {
  return (
    <footer className="bg-blue-950 text-white pt-12 pb-8 mt-20">
      <div className="max-w-6xl mx-auto px-4 text-center">
        <div className="flex justify-center items-center space-x-6 mb-6">
          <SocialLink href="https://github.com/fireburn553">
            <svg
              className="w-6 h-6"
              fill="currentColor"
              viewBox="0 0 24 24"
          ...
          <SocialLink href="https://linkedin.com/in/jamessalva">
            <svg
              className="w-6 h-6"
              fill="currentColor"
              viewBox="0 0 24 24"
        ...
        <p className="text-sm text-gray-500">
          &copy; {new Date().getFullYear()} James Charlie Salva. All rights
          reserved.
        </p>
      </div>
    </footer>
